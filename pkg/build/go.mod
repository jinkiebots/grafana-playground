...
require (
	...
	go.opentelemetry.io/otel v1.46.0 // indirect; @grafana/grafana-backend-group
	go.opentelemetry.io/otel/sdk v1.46.0 // indirect; @grafana/grafana-backend-group
	go.opentelemetry.io/otel/trace v1.46.0 // indirect; @grafana/grafana-backend-group
	golang.org/x/net v0.58.0 // indirect; @grafana/oss-big-tent @grafana/partner-datasources
	golang.org/x/sync v0.22.0 // @grafana/alerting-backend
	golang.org/x/text v0.41.0 // indirect; @grafana/grafana-backend-group
