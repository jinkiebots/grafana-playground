...
require (
	...
	cloud.google.com/go/storage v1.62.0 // @grafana/grafana-backend-group
	...
	github.com/aws/smithy-go v1.24.3 // @grafana/aws-datasources
	...
	github.com/thomaspoignant/go-feature-flag v1.52.1 // @grafana/grafana-backend-group
