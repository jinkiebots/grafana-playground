...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/ec2 v1.254.1 // @grafana/aws-datasources
	...
	github.com/prometheus/prometheus v0.307.3 // @grafana/alerting-backend
	...
	google.golang.org/api v0.250.0 // @grafana/grafana-backend-group
