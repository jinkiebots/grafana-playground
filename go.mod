...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs v1.78.0 // @grafana/aws-datasources
	github.com/aws/aws-sdk-go-v2/service/ec2 v1.308.0 // @grafana/aws-datasources
