...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs v1.77.0 // @grafana/aws-datasources
	github.com/aws/aws-sdk-go-v2/service/ec2 v1.307.1 // @grafana/aws-datasources
